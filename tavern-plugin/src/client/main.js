	...
	factory: (require) => {
		...
		function createTavernMessageFrameLifecycle(initial, options) {
			...
			function receive(event) {
				...
				} else if (data.type === "dsh-tavern-helper-call" && !props.sessionId && props.openingPreview && props.openingPreview.runtime) {
