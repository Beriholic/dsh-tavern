...
test('更多菜单收起回退和压缩，并可再次关闭', () => {
  ...
  assert.deepEqual(more.children[1].children.map(child => child.type.name), ['TavernStopBackgroundAction', 'TavernEditBodyAction', 'TavernRollbackAction', 'TavernCompactionAction'])
})
